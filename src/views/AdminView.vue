<template>
  <el-container>
    <el-header class="pageHeader"> 管理后台 </el-header>
      ...
      <el-aside width="300px">
        ...
        >
          ...
          <el-submenu index="2">
            ...
            <el-menu-item-group>
              <el-menu-item>
                <router-link to="/admin/adduser">增加用户</router-link>
              </el-menu-item>
              <el-menu-item>
          ...
          <el-submenu index="3">
            ...
            <el-menu-item-group>
              <el-menu-item>
                <router-link to="/admin/addmovie">增加电影</router-link>
              </el-menu-item>
              <el-menu-item>
          ...
          <el-submenu index="4">
            ...
            <el-menu-item-group>
              <el-menu-item>
                <router-link to="/admin/addcinema">增加影院</router-link>
              </el-menu-item>
              <el-menu-item>
                <router-link to="/admin/cinemanage">影院列表</router-link>
              </el-menu-item>
            </el-menu-item-group>
          </el-submenu>
          <el-submenu index="5">
